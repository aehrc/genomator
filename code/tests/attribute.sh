...
run_attribute_inference () {
    ...
    attribute_inference_experiment.py "${files[@]}" --max_samples=200 --silent=True >> $result_file
}
...
cat "${result_file}" | attribute_process.py "${RESULTS_DIR}" > "${RESULTS_DIR}/results_raw.tsv"

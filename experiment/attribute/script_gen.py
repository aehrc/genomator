...
def mark_run(f,i):
    f.write(f"MARK_run.py ../sources/805_SNP_1000G_real_split_haplotypes1.vcf.gz MARK_A_{i}.vcf 2504 --window_leng={i}\n")
    f.write(f"MARK_run.py ../sources/805_SNP_1000G_real_split_haplotypes2.vcf.gz MARK_B_{i}.vcf 2504 --window_leng={i}\n")
    ...
    f.write(f"echo MARKOV_{i} >> results.txt\n")
...
def rbm_run(f,nh,lr):
    f.write(f"RBM_run.py ../sources/805_SNP_1000G_real_split_haplotypes1.vcf.gz RBM_A_{nh}_{lr} 2504 --dump_output_interval=1200 --gpu=True --ep_max=1250 --nh={nh} --lr={lr}\n")
    f.write(f"RBM_run.py ../sources/805_SNP_1000G_real_split_haplotypes2.vcf.gz RBM_B_{nh}_{lr} 2504 --dump_output_interval=1200 --gpu=True --ep_max=1250 --nh={nh} --lr={lr}\n")
...
def crbm_run(f,nh):
    f.write(f"CRBM_run.py ../sources/805_SNP_1000G_real_split_haplotypes1.vcf.gz CRBM_A_{nh} 2504 --dump_output_interval=1200 --gpu=True --ep_max=1250 --nh={nh}\n")
    f.write(f"CRBM_run.py ../sources/805_SNP_1000G_real_split_haplotypes2.vcf.gz CRBM_B_{nh} 2504 --dump_output_interval=1200 --gpu=True --ep_max=1250 --nh={nh}\n")
...
def gan_run(f,m):
    f.write(f"GAN_run_orig.py ../sources/805_SNP_1000G_real_split_haplotypes1.vcf.gz GAN_A_{m} 2504 --dump_output_interval=20000 --epochs=20010 --layer_multiplier={m}\n")
    f.write(f"GAN_run_orig.py ../sources/805_SNP_1000G_real_split_haplotypes2.vcf.gz GAN_B_{m} 2504 --dump_output_interval=20000 --epochs=20010 --layer_multiplier={m}\n")

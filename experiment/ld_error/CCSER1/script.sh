...
MARK_run.py ../../sources/CCSER1.vcf.gz MARK.vcf 1000 --window_leng=30
...
ld14.py ../../sources/CCSER1.vcf.gz CRBM.vcf GAN.vcf GENOMATOR.vcf MARK.vcf RBM.vcf --max_offset=500 --max_y_limit=0.025 --chunk_size=15
echo results > results.txt
ld_window_analysis.py ../../sources/CCSER1.vcf.gz CRBM.vcf GAN.vcf GENOMATOR.vcf MARK.vcf RBM.vcf --max_offset=500 --max_y_limit=0.025 --chunk_size=15 --output_image_file=LD_window.png >> results.txt
ld11.py ../../sources/CCSER1.vcf.gz >> results.txt
echo average >> results.txt
ld10.py ../../sources/CCSER1.vcf.gz CRBM.vcf GAN.vcf GENOMATOR.vcf MARK.vcf RBM.vcf >> results.txt
...
get_correlation.py ../../sources/CCSER1.vcf.gz MARK.vcf >> results.txt

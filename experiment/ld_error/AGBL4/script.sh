...
ld14.py ../../sources/AGBL4.vcf.gz CRBM.vcf GAN.vcf GENOMATOR.vcf MARK.vcf RBM.vcf --max_offset=500 --max_y_limit=0.025 --chunk_size=15
echo results > results.txt
ld_window_analysis.py ../../sources/AGBL4.vcf.gz CRBM.vcf GAN.vcf GENOMATOR.vcf MARK.vcf RBM.vcf --max_offset=500 --max_y_limit=0.025 --chunk_size=15 --output_image_file=LD_window.png >> results.txt
ld11.py ../../sources/AGBL4.vcf.gz >> results.txt
echo average >> results.txt
ld10.py ../../sources/AGBL4.vcf.gz CRBM.vcf GAN.vcf GENOMATOR.vcf MARK.vcf RBM.vcf >> results.txt
...
get_correlation.py ../../sources/AGBL4.vcf.gz MARK.vcf >> results.txt

...
def crbm_run1(f):
  ...
  f.write(f"CRBM_run.py {vcf_file_split1_pickle} {out_file1} 2500 --fixnodes=5000 --dump_output_interval=500 --ep_max=90001 --gpu=True\n")
def crbm_run2(f):
  out_file1 = out_template.format("crbm_split1_bigger")
  out_file2 = out_template.format("crbm_split2_bigger")
  f.write(f"CRBM_run.py {vcf_file_split2_pickle} {out_file2} 2500 --fixnodes=5000 --dump_output_interval=500 --ep_max=90001 --gpu=True\n")
...
def wgan_run1(f):
  ...
  f.write(f"WGAN_run.py {vcf_file_split1_pickle} {out_file1} 2500 --dump_output_interval=120 --epochs=8001\n")
def wgan_run2(f):
  out_file1 = out_template.format("wgan_split1_bigger")
  out_file2 = out_template.format("wgan_split2_bigger")
  f.write(f"WGAN_run.py {vcf_file_split2_pickle} {out_file2} 2500 --dump_output_interval=120 --epochs=8001\n")

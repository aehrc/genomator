...
def mark_run(f,i):
  ...
  f.write(f"/usr/bin/time -v MARK_run2.py {vcf_file_split1_pickle} {out_file1} 120 --window_leng={i} \n")
  f.write(f"/usr/bin/time -v MARK_run2.py {vcf_file_split2_pickle} {out_file2} 120 --window_leng={i} \n")

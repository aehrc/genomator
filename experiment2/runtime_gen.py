...
methods = {
  ...
  "GENOMATOR":("genomator     ../sources/chr_filtered_{0}.vcf.gz.pickle dummy_output_GENO{0} 1 0 0 --sample_group_size=150 --exception_space=-1.5 --solver_name=tinicard --difference_samples=100 --noise=0 --involutions=1 --looseness=0.99 --kull=300 -nb","virga_header_nerfed")
}
